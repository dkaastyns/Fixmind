# ASETKITA Semarang — Dokumentasi Pustaka Komponen (Component Library)

Dokumen ini menjelaskan sistem desain UI, prinsip dasar, dan dokumentasi komponen visual yang dapat digunakan kembali (*reusable UI components*) di modul Frontend aplikasi ASETKITA Semarang.

---

## 1. Prinsip Desain & Visual (Design System)

Frontend ASETKITA Semarang dirancang menggunakan kombinasi gaya **Minimalism** dan **Glassmorphism** untuk menciptakan kesan modern, premium, dan bersih layaknya produk SaaS kelas dunia (seperti Vercel, Linear, atau Notion).
...
Semua komponen UI terletak di direktori [frontend/src/components/ui/](file:///d:/ASETKITA Semarang/frontend/src/components/ui).

### A. Tombol (`Button`)
Komponen tombol standar dengan varian desain modern.
* **File:** [button.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/button.tsx)
* **Varian (`variant`):**
  * `primary`: Gradasi oranye-merah muda khas ASETKITA Semarang.
...
* **File:** [input.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/input.tsx) dan [password-input.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/password-input.tsx)
...
* **File:** [glass-card.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/glass-card.tsx) dan [animated-glass-card.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/animated-glass-card.tsx)
...
* **File:** [global-search-modal.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/global-search-modal.tsx)
...
* **File:** [notification-bell.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/notification-bell.tsx)
...
* **File:** [delete-confirmation-modal.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/delete-confirmation-modal.tsx)
...
* **File:** [error-boundary.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/error-boundary.tsx)
...
* **Lokasi Pengujian:** Berdampingan dengan berkas komponen (contoh: [button.spec.tsx](file:///d:/ASETKITA Semarang/frontend/src/components/ui/button.spec.tsx)).
