...
autoTable(doc, {
  ...
  body: [
    ...
    ['5. Servis Berkala (Maintenance)', 'Atur kalender perawatan rutin untuk fasilitas penting gedung seperti AC sentral, genset listrik, lift, dan sound system ruang rapat.'],
  ],
  theme: 'grid',
  headStyles: { fillColor: [26, 26, 26], textColor: [255, 255, 255], fontSize: 8 },
...
console.log('PDF generated successfully at:', outputPath, 'Total Pages:', totalPages, 'Size:', buffer.length, 'bytes');
