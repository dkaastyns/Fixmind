      ...
      >
        ...
        <div className="glass-dark p-6 sm:p-8 shadow-2xl border-white/10 bg-slate-950/45 backdrop-blur-xl">
          <form className="space-y-4" onSubmit={form.handleSubmit((v) => mutation.mutate(v))}>
            ...
            <button
              type="submit"
              className="w-full mt-4 h-11 rounded-2xl text-white font-bold gradient-gold shadow-[0_4px_15px_rgba(228,181,43,0.3)] hover:opacity-95 active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
              disabled={mutation.isPending}
            >
              {mutation.isPending ? (
                <>
