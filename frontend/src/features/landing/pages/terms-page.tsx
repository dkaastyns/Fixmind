...
const highlights = [
  ...
  { icon: Clock, text: 'Notifikasi & Tracking Real-time' },
    ...
    <div className="relative min-h-screen overflow-hidden bg-slate-950 py-8 md:py-12 px-4">
      ...
      >
        ...
        <motion.div 
          ...
          className="absolute top-1/4 left-1/4 w-[500px] h-[500px] bg-[#F9D141]/12 rounded-full filter blur-[130px] pointer-events-none" 
        />
        <motion.div 
          ...
          <div className="p-6 md:p-10 shadow-[0_16px_48px_rgba(0,0,0,0.5)] border border-white/15 bg-slate-900/60 backdrop-blur-2xl rounded-3xl relative overflow-hidden">
            ...
            <div className="mb-8 flex justify-center">
              <div className="inline-flex p-1.5 rounded-2xl bg-slate-950/80 border border-white/10 backdrop-blur-xl">
                <Link to="/terms" className="relative px-5 py-2.5 text-xs md:text-sm font-bold transition-colors cursor-pointer text-white">
                ...
                <Link to="/privacy" className="relative px-5 py-2.5 text-xs md:text-sm font-bold transition-colors cursor-pointer text-slate-400 hover:text-white">
